...
export class HttpTransportHandler {
   ...
   * Note: Always uses 'localhost' for redirect_uri since Google OAuth doesn't accept 0.0.0.0
   */
  private async createOAuth2Client(accountId: string, host: string, port: number): Promise<import('google-auth-library').OAuth2Client> {
    ...
    // Always use localhost for redirect_uri - Google OAuth doesn't accept 0.0.0.0
